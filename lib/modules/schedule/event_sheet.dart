...
import '../campus_map/campus_geo.dart';
...
void _openRoomMap(
  ...
  if (navigation != null) {
    navigation.onOpenMap(buildingCode, startGuidance: startGuidance);
    return;
  }
  navigator.push(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (room.isResolved &&
                    geo != null &&
                    geo.byCode(room.buildingCode!) != null) ...[
                  const SizedBox(height: CampusSpacing.x4),
                  CampusMapPreview(
                    geo: geo,
                    buildingCode: room.buildingCode!,
                    onTap: () => _openRoomMap(context, room),
                  ),
                ],
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    if (room.isResolved &&
                        ...
                        geo.entrances.any(
                          (entrance) =>
                              entrance.code == room.buildingCode &&
                              entrance.node >= 0,
                        ))
                      FilledButton.icon(
                        onPressed: () =>
                            _openRoomMap(context, room, startGuidance: true),
